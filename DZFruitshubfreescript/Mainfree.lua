...
MODILEGUISOMEXHUB.Text = "closegui"
...
spawn(function()
    ...
    Settings:Toggle("Bring Mob then farm",true,function(value)
    _G.BringMonster = value
    end)

    Settings:Toggle("Bring Mob Auto",true,function(vu)
    _G.MagnetActive = vu
    end)
...
spawn(function()
    ...
    Settings:Toggle("Super fast Attackตีไวแบบ99.9%",false,function(value)
        local plr = game.Players.LocalPlayer

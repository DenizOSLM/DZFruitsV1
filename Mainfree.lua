    ...
    function CheckQuest() 
        ...
        elseif World3 then
            ...
            elseif MyLevel == 2275 or MyLevel <= 2299 then
                ...
                NameQuest = "CakeQuest2"
                NameMon = "Head Baker"
                CFrameQuest = CFrame.new(-2216.188232421875, 82.884521484375, -12869.2939453125)
            elseif MyLevel == 2300 or MyLevel <= 2324 then
                Mon = "Cocoa Warrior [Lv. 2300]"
                LevelQuest = 1
                NameQuest = "ChocQuest1"
                NameMon = "Cocoa Warrior"
                CFrameQuest = CFrame.new(-21.55328369140625, 80.57499694824219, -12352.3876953125)
            elseif MyLevel == 2325 or MyLevel <= 2349 then
                Mon = "Chocolate Bar Battler [Lv. 2325]"
                LevelQuest = 2
                NameQuest = "ChocQuest1"
                NameMon = "Chocolate Bar Battler"
                CFrameQuest = CFrame.new(582.590576171875, 77.18809509277344, -12463.162109375)
            elseif MyLevel == 2350 or MyLevel <= 2374 then
                Mon = "Sweet Thief [Lv. 2350]"
                LevelQuest = 1
                NameQuest = "ChocQuest2"
                NameMon = "Sweet Thief"
                CFrameQuest = CFrame.new(165.1884765625, 76.05885314941406, -12600.8369140625)
            elseif MyLevel == 2375 or MyLevel <= 2399 then
                Mon = "Candy Rebel [Lv. 2375]"
                LevelQuest = 2
                NameQuest = "ChocQuest2"
                NameMon = "Candy Rebel"
                CFrameQuest = CFrame.new(134.86563110351562, 77.2476806640625, -12876.5478515625)
            elseif MyLevel == 2400 or MyLevel <= 2449 then
                Mon = "Candy Pirate [Lv. 2400]"
                LevelQuest = 1
                NameQuest = "CandyQuest1"
                NameMon = "Candy Pirate"
                CFrameQuest = CFrame.new(-1310.5003662109375, 26.016523361206055, -14562.404296875)
            elseif MyLevel <= 2450 then
                Mon = "Snow Demon [Lv. 2425]"
                LevelQuest = 2
                NameQuest = "CandyQuest1"
                NameMon = "Snow Demon"
                CFrameQuest = CFrame.new(-899.0391235351562, 26.511367797851562, -14430.8681640625)
            end
        end
    end
...
local Library = Update:Window("Exotica x Hub","",Enum.KeyCode.RightControl);
Main = Library:Tab("Home")
M = Library:Tab("Item & Quest")
Ss = Library:Tab("Status")
P = Library:Tab("PVP")
R = Library:Tab("Raid")
T = Library:Tab("Islands")
S = Library:Tab("Shop")
D = Library:Tab("Fruit")
...
Main:Label("By YouTube DZ Fruits!!")

Main:Button("Copy Link YouTube",function()
...
spawn(function()
   while wait() do
    ...
    local SelectWeapona = Main:Dropdown("Select Tools",WeaponList,function(value)
        _G.SelectWeapon = value
    end)
    
    Main:Button("Refresh Tools",function()
        SelectWeapona:Clear()
        for i,v in pairs(game:GetService("Players").LocalPlayer.Backpack:GetChildren()) do  
...
Main:Toggle("Auto Farm Level",_G.AutoFarm,function(value)
                                    ...
                                    if v.Name == Mon then
                                        if string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, NameMon) then
                                            repeat task.wait()
                                                ...
                                                TP1(v.HumanoidRootPart.CFrame * CFrame.new(5,40,5))
    ...
    Main:Toggle("Auto Dough Boss v2", _G.AutoDoughv2,function(value)
         _G.AutoDoughBoss = value
        StopTween( _G.AutoDoughv2)
    end)
    
    spawn(function()
        while wait() do
            if  _G.AutoDoughv2 then
                pcall(function()
                            ...
                            if v.Name == "Dough King [Lv. 2300] [Raid Boss]" then
                                if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                    repeat task.wait()
                                        ...
                                        v.Humanoid.WalkSpeed = 0
                                        v.HumanoidRootPart.Size = Vector3.new(50,50,50)
                                        topos(v.HumanoidRootPart.CFrame * CFrame.new(10,40,10))
                                        game:GetService("VirtualUser"):CaptureController()
                                        game:GetService("VirtualUser"):Button1Down(Vector2.new(1280,672))
                                        sethiddenproperty(game.Players.LocalPlayer,"SimulationRadius",math.huge)
                                    until not  _G.AutoDoughv2 or not v.Parent or v.Humanoid.Health <= 0
                                end
                            end
                        end
                    else
    ...
    Main:Toggle("Auto Dough Boss v2 Hop", _G.AutoDoughBossHop,function(value)
         _G.AutoDoughv2Hop = value
    end)
    
    Main:Toggle("Auto Farm Magma ore Sea1", _G.magmaore,function(value)
         _G.Automagmaore = value
        StopTween( _G.Automagmaore)
    end)
                ...
                pcall(function()
                    if game:GetService("Workspace").Enemies:FindFirstChild("Military Soldier [Lv. 300]") then
                            ...
                            if v.Name == "Military Soldier [Lv. 300]" then
                                if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                    repeat task.wait()
                                        ...
                                        game:GetService("VirtualUser"):Button1Down(Vector2.new(1280,672))
                                        sethiddenproperty(game.Players.LocalPlayer,"SimulationRadius",math.huge)
                                    until not  _G.Automagmaore or not v.Parent or v.Humanoid.Health <= 0
                                end
                            end
                        end
                    else
                        ...
                        if game:GetService("ReplicatedStorage"):FindFirstChild("Military Soldier [Lv. 300]") then
                            topos(game:GetService("ReplicatedStorage"):FindFirstChild("Military Soldier [Lv. 300]").HumanoidRootPart.CFrame * CFrame.new(2,20,2))
                        else
                            if  _G.AutomagmaHop then
                                Hop()
                            end
                        end
                    end
    ...
    Main:Toggle("Auto Farm Deagon Scale", _G.Autofarmdeagonscale,function(value)
         _G.Autofarmdeagonscale = value
        StopTween( _G.AutoFarmDeagonscale)
    end)
    
    spawn(function()
        while wait() do
            if  _G.Autofarmdeagonscale then
                pcall(function()
                    if game:GetService("Workspace").Enemies:FindFirstChild("Dragon Crew Warrior [Lv. 1575]") then
                            ...
                            if v.Name == "Dragon Crew Warrior [Lv. 1575]" then
                                if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                    repeat task.wait()
                                        ...
                                        game:GetService("VirtualUser"):Button1Down(Vector2.new(1280,672))
                                        sethiddenproperty(game.Players.LocalPlayer,"SimulationRadius",math.huge)
                                    until not  _G.Autofarmdragonlscale or not v.Parent or v.Humanoid.Health <= 0
                                end
                            end
                        end
                    else
                        if game:GetService("ReplicatedStorage"):FindFirstChild("Dragon Crew Warrior [Lv. 1575]") then
                            ...
                            if  _G.AutoFarmdeagonscaleHop then
                                Hop()
                            end
                        end
                    end
...
Main:Toggle("Bring Mon then farm",true,function(Mag)
    _G.BringMonster = Mag
    end)
    spawn(function()
        while task.wait() do
...
spawn(function()
    ...
    Main:Toggle("Bring Mon Auto",true,function(vu)
    _G.MagnetActive = vu
    end)
...
elseif _G.WhiteScreen == false then
    ...
    local SelectWeapona = M:Dropdown("Select Tools",WeaponList,function(value)
        _G.SelectWeapon = value
    end)
    ...
    M:Toggle("Auto God Human",_G.AutoGodHuman,function()

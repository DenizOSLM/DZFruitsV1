...
local Library = win:Server("Destiny Hub","")

local Main = Library:Channel("Main","rbxassetid://6026568198")
local Setting = Library:Channel("Settings","rbxassetid://6034509993")
local Weapon = Library:Channel("Weapons","rbxassetid://11162889532")
local Stats = Library:Channel("Stats","rbxassetid://11155953071")
local P = Library:Channel("Player","rbxassetid://7251993295")
local polo = Library:Channel("Teleport","rbxassetid://11155986081")
local Dungeon = Library:Channel("Dungeon","rbxassetid://11155851001")
local DevilFruit = Library:Channel("Fruit+Esp","rbxassetid://6031265976")
local Shop = Library:Channel("Shop","rbxassetid://11156000139")
local Misc = Library:Channel("Misc","rbxassetid://11156061121")
...
spawn(function()
    game:GetService("RunService").RenderStepped:Connect(function()
        if _G.Auto_Farm_Level or _G.Auto_Farm_Bone or _G.MeleeFarm or _G.Auto_Farm_Sword or _G.Auto_Farm_Boss then
             pcall(function()
                game:GetService'VirtualUser':CaptureController()
...
Setting:Label("\\\\\  Settings Mastery  //")
...
Weapon:Label("\\\\\  Dual Curse Katana  //")
...
StopTween(_G.Auto_Evo_Race_V2)
	...
	spawn(function()
		...
		Weapon:Toggle("Auto Buy Legendary Sword",_G.BuySword,function(Value)
			_G.BuySword = Value
		end)
		spawn(function()
...
polo:Label("\\\\\  WORLD  //")
 ...
 polo:Button("Teleport To Old World",function()
  game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelMain")
  end)
 
 polo:Button("Teleport To Second Sea",function()
  game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelDressrosa")
 end)

 
 polo:Button("Teleport To Third Sea",function()
  game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelZou")
  end)
 
 polo:Button("Teleport to Seabeast",function()
 ...
 polo:Toggle("Teleport",false,function(value)
 ...
 polo:Button("Instant Teleport",function()
		 _G.Instant = true
...
Dungeon:Label("Use in Dungeon Only!")
